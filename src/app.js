...
lnButton.addEventListener('click', performNaturalLog);
logButton.addEventListener('click', performDecimalLog);
expByPowerButton.addEventListener('click', performExpByPower);
...
percentButton.addEventListener('click', performPercentOperation);
...
expButton.addEventListener('click', () => {document.querySelector(".result").value = Math.exp(1)});
